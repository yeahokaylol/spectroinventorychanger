...
public:
	...
	static Color Redskeet() { return Color(166, 12, 9); }
	static Color Greenskeet() { return Color(113, 184, 7); }
...
struct BulletImpact_t
{
	...
	__forceinline BulletImpact_t(CBaseEntity* player, Vector pos, float time, Color col = Color::White())
	{
		pPlayer = player;
		flImpactTime = time;
		vecImpactPos = pos;
...
}; extern CBulletTracer* g_pBulletTracer;