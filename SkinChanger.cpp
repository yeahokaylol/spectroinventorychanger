...
void SetSkinCFG() {
	...
	// HS AK-47 | SCREAMMYKK
	g_SkinCFG[WEAPON_AK47].nFallbackPaintKit = 639;
	...
	g_SkinCFG[WEAPON_M4A1S].nFallbackPaintKit = 644;
	g_SkinCFG[WEAPON_M4A1S].nFallbackStatTrak = 1337;
	...
	// USP-S | 
	g_SkinCFG[WEAPON_USPS].nFallbackPaintKit = 653;
	g_SkinCFG[WEAPON_USPS].nFallbackStatTrak = 1337;
	g_SkinCFG[WEAPON_SSG08].nFallbackPaintKit = 503;
	g_SkinCFG[WEAPON_SSG08].nFallbackStatTrak = 503;
	g_SkinCFG[WEAPON_SCAR20].nFallbackPaintKit = 597;
	g_SkinCFG[WEAPON_SCAR20].nFallbackStatTrak = 503;
	// Kerambit | KitaecNePokrasilScam (CT)
	g_SkinCFG[WEAPON_KNIFE].nItemDefinitionIndex = WEAPON_KNIFE_KARAMBIT;

	g_SkinCFG[WEAPON_KNIFE].nEntityQuality = 4;

	// Kerambit | KitaecNePokrasilScam(T)
	g_SkinCFG[WEAPON_KNIFE_T].nItemDefinitionIndex = WEAPON_KNIFE_KARAMBIT;

	g_SkinCFG[WEAPON_KNIFE_T].nEntityQuality = 4;
...
void SetViewModelCFG() {
	...
	g_ViewModelCFG[nOriginalKnifeT] = "models/weapons/v_knife_karam.mdl";

}

void SetKillIconCFG() {
	// Define replacement kill icons. (these only apply to you)
	g_KillIconCfg["knife_default_ct"] = "knife_karam";
	g_KillIconCfg["knife_t"] = "knife_karam";
}
